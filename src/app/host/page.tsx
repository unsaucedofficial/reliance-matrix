            ...
            >
              ...
              <div className="grid grid-cols-3 gap-2 mb-6">
                <div className="bg-cyan-500/10 border border-cyan-500/20 rounded-xl p-3 text-center">
                  ...
                  <p className="text-[10px] text-gray-500">Battle of Logic</p>
                </div>
                <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-3 text-center">
                  <p className="text-lg">⚔️</p>
                  <p className="text-xs font-bold text-amber-400">Round 2</p>
                  <p className="text-[10px] text-gray-500">Battle of Wits</p>
                </div>
                <div className="bg-green-500/10 border border-green-500/20 rounded-xl p-3 text-center">
                  <p className="text-lg">🧠</p>
                  <p className="text-xs font-bold text-green-400">Round 3</p>
                  <p className="text-[10px] text-gray-500">Battle of Instinct</p>
                </div>
              </div>
